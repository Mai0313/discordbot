...
Do not delete `OwnedPublicView` or `edit_owned_public_message` for want of a
caller: they are the one worked-out answer to owning a public message across
restarts, deletions and idle expiry, which is a lot to rederive for the next
panel.
"""
