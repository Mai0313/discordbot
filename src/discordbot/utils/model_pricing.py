...
from discordbot.typings.timeouts import MODEL_PRICE_FETCH_TIMEOUT_SECONDS
...
def _fetch_table() -> str | None:
    ...
    try:
        response = requests.get(url=MODEL_INFO_URL, timeout=MODEL_PRICE_FETCH_TIMEOUT_SECONDS)
