...
_HELP_CONTENT = {
    "default": {
        ...
        "stocks": (
            ...
            "`/stock` opens the market UI for prices, market-context news, positions, charts, supply-capped buy and short entries, plus sell and cover exits."
        ),
        "vip": (
            "**VIP**\n"
    ...
    Locale.zh_TW: {
        ...
        "stocks": (
            "**模擬股市**\n"
            "`/stock` 開啟 market UI，可以看價格、參考 market context 的 news、position、chart，也能建立受 supply cap 限制的 buy/short，或執行 sell/cover 出場。"
        ),
    ...
    Locale.ja: {
        ...
        "stocks": (
            "**シミュレーション株式市場**\n"
            "`/stock` で market UI を開き、price、market context 付き news、position、chart、supply cap 付きの buy/short entry、sell/cover exit を扱えます。"
        ),
        "vip": (
            "**VIP**\n"
