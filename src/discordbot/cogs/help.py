...
_HELP_CONTENT = {
    "default": {
        ...
        "games": (
            ...
            "After every player stands or busts, the AI dealer decides each hit / stand; "
            "the final result shows the dealer decision path.\n"
    ...
    Locale.zh_TW: {
        ...
        "games": (
            ...
            "後續玩家預設跟這個金額，"
            "不操作 180 秒會自動 stand。所有玩家結束後, AI 莊家會決定每一步 hit / stand, "
    ...
    Locale.ja: {
        ...
        "games": (
            ...
            "参加者はその金額を既定で賭けます。"
            "180秒操作がない場合は自動 stand。全員の action 後、AI dealer が各 hit / stand "
            "を決定し、final result に decision path を表示します。\n"
