...
_HELP_CONTENT = {
    "default": {
        ...
        "games": (
            ...
            "the AI dealer decides hit / stand, and the final embed shows the dealer action path.\n"
    ...
    Locale.zh_TW: {
        ...
        "games": (
            ...
            "且 21 點算一般 win（不是 natural Blackjack 3:2）；Late Surrender 會輸掉進位後的一半本金\n"
            ...
            "final result 會顯示 dealer action path\n"
    ...
    Locale.ja: {
        ...
        "games": (
            ...
            "21 になっても natural BJ 扱いではなく 1:1。Late Surrender は切り上げ半額を失います。\n"
            ...
            "final result に dealer action path を表示します。\n"
