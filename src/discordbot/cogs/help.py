...
_HELP_CONTENT = {
    "default": {
        ...
        "games": (
            ...
            "(½ of the original wager, requires uncommitted balance, pays 2:1 if the dealer "
    ...
    Locale.zh_TW: {
        ...
        "games": (
            ...
            "莊家明牌 **A** 時會先進入保險階段（保險注 = 原注一半，需要剩餘可用餘額，"
            "莊家 BJ 賠 2:1）；"
    ...
    Locale.ja: {
        ...
        "games": (
            ...
            "(原 bet の半額、未committed balance が必要、dealer BJ なら 2:1)、"
