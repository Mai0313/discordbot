        ...
        sections={
            ...
            "tools": HelpSection(
                ...
                detail=(
                    ...
                    "Tag me with the link instead and I'll read the post along with the "
                    "comments under it and answer about it.\n\n"
                    "Douyin parser\n"
        ...
        sections={
            ...
            "tools": HelpSection(
                ...
                detail=(
                    ...
                    "改成 tag 我並附上連結,我就會連底下的留言一起讀過再回答你。\n\n"
                    "抖音解析\n"
        ...
        sections={
            ...
            "tools": HelpSection(
                ...
                detail=(
                    ...
                    "メンション付きでリンクを送ると、投稿とその下のコメントまで読んで"
                    "その内容に答えます。\n\n"
                    "抖音パーサー\n"
