        ...
        sections={
            ...
            "games": HelpSection(
                ...
                detail=(
                    ...
                    "View a player's recent Blackjack rounds as a private board: hands, bets, dealer hands, and results. Defaults to yourself and the last 10 rounds (up to 50).\n\n"
                    "**`/games dragon_gate`**\n"
        ...
        sections={
            ...
            "games": HelpSection(
                ...
                detail=(
                    ...
                    "**`/games blackjack_history [member] [count]`**\n"
                    "以私人圖表查看某位玩家近期的 21 點對局：手牌、下注、莊家手牌與結果；預設查自己、近 10 場（最多 50）。\n\n"
                    "**`/games dragon_gate`**\n"
                    "開射龍門 jackpot 桌。"
                ),
            ),
        ...
        sections={
            ...
            "games": HelpSection(
                ...
                detail=(
                    ...
                    "**`/games blackjack_history [member] [count]`**\n"
                    "プレイヤーの最近のブラックジャックの対局をプライベートなボードで表示：手札、賭け金、ディーラーの手札、結果。既定は自分・直近 10 件（最大 50）。\n\n"
                    "**`/games dragon_gate`**\n"
