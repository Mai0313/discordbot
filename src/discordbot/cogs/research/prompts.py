...
The QA `<deep-research>` marker instruction lives in `gen_reply/prompts.py`, not here.
"""

# The system_instruction handed to the research agent.
...
# A short side call (triage_model) turns the research brief into a Discord thread title. Brevity
# is steered by the prompt (not a token cap); the cog still trims to Discord's hard name limit.
