...
IMAGE_PROMPT = f"""
{PERSONA_CHOICES}
* Your response should be clear, and you should try to provide a straight answer to what the user asked for.
* The image you receive is generated BY YOU. Naturally weave a brief description of the image (main subject, style, or mood) into your reply instead of writing it as a standalone caption.
{COMMON_PROMPT}
"""
