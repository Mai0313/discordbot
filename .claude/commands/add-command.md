...
## argument-hint: [command-name] description: Generate a new command for Claude Code CLI tools: Bash, Edit, Glob, Grep, MultiEdit, NotebookEdit, NotebookRead, Read, Task, TodoWrite, WebFetch, WebSearch, Write model: anthropic.claude-sonnet-4-5-20250929-v1:0
