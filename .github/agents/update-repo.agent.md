...
User will provide a template repository link, BUT some of project related files and folders should be kept unchanged, you need to check the following files and folders to determine which files and folders should be updated and which should be kept unchanged
