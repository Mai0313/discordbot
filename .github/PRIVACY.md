...
| Discord user ID, display name, avatar URL, and game state (balances, transactions, positions, match history) | Your use of the economy, casino and stock commands                                                                                                  | Running those features. The currency is virtual, has no monetary value, and no payment information is ever collected.                                                                   |
