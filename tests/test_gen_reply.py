...
# openai 3.x builds its exceptions on httpx2, so a request/response handed to one has to come
# from there; google-genai is still on httpx 0.x, and both live in the environment at once.
import httpx2
