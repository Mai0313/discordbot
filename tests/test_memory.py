...
async def test_pipeline_consolidation_writes_tone_note(
    ...
    # order-contract: tone consolidation runs after the two fact-compartment calls.
    assert "<existing_tone>\n## 語氣偏好\n* 舊語氣\n</existing_tone>" in seen_inputs[2]
    # order-contract: the preceding guild-fact call must not receive the tone document.
