...
- **标记聊天**：只需标记机器人（@机器人）就能开始对话 — 支持文字和图片输入，整合多种 AI 模型（OpenAI GPT-4o — 默认、GPT-5-mini、GPT-5-nano、Claude-3.5-Haiku）与**默认流模式**（约每 10 个字更新一次）
...
| 指令            | 功能说明       | 特色功能                                                                                                                               |
| --------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| `@标记`         | 标记机器人聊天 | 多模型 AI（默认 GPT-4o、另含 GPT-5 mini/nano、Claude 3.5 Haiku）、**默认流模式**（约每 10 个字更新）、图像输入、自动网络搜索与用户记忆 |
