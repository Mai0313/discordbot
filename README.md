...
| Slash command      | Game                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/blackjack <bet>` | Multiplayer 21 lobby with Join / Leave / Start buttons. Player actions include **Hit / Stand / Double Down / Split / Surrender**, plus an Insurance side bet whenever the dealer up-card is an Ace and the player still has uncommitted balance. After every hand stands or busts the AI dealer decides hit / stand for the house (Soft 17 is left up to the model).                                                                                                         |
