...
- **Simulated stock market**: `/stock` opens one public market message with multiple virtual companies; selecting a stock opens a private detail panel for trading, position summaries, recent trades, periodically refreshed news, and a 7D chart. Only the opener can operate that panel's controls.
...
| `/stock`                                                         | Opens one public stock market message with private detail, trading, news, and history panels.                          |
...
- `stock.db`: simulated stock profiles, price ticks, positions, trade operations, ordered trade legs, and AI-or-fallback stock news.
