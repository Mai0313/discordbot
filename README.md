...
- **Simulated stock market**: `/stock` opens one public BCAT market message with same-message detail, trading, position summaries, recent trades, news, and a 7D chart. Only the opener can operate that panel's controls.
