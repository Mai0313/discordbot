...
- **Threads parser**: paste a Threads.net or Threads.com URL and the bot expands the post, media, and reply chain. Mention the bot alongside the link and it also reads the post and answers about it.
- **Douyin parser**: paste a Douyin link and the bot posts the video (or the photo post's images) straight into the channel. Mention the bot alongside the link and it also watches the clip and answers about it.
...
| _Threads URL_                                                    | Automatically expands Threads posts and media; mentioning the bot also gets an answer about the post.                  |
| _Douyin URL_                                                     | Automatically posts the video or photos; mentioning the bot also gets an answer about it.                              |
