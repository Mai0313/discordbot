...
| Slash command      | Game                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/blackjack <bet>` | Multiplayer-ready 21 lobby with Join / Leave / Start buttons, then per-player Hit / Stand turns. Natural Blackjack pays 1.5×; the dealer uses only the visible dealer card for hints, then AI decides dealer hit / stand after players finish.                                                                                                                                                                                                                               |
...
| `/blackjack <bet>`                | Open a 21 lobby; players take Hit / Stand turns, then AI decides dealer actions       |
