...
- **標記聊天**：只需標記機器人（@機器人）就能開始對話，無需使用指令 — 支援文字和圖片輸入
...
| 指令            | 功能說明         | 特色功能                                                                                                                                    |
| --------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| `/oai`          | 生成 AI 文字回應 | 多模型支援（預設 GPT-4o、另含 GPT-5 mini/nano、Claude 3.5 Haiku）、**預設串流模式**（約每 10 個字更新）、圖像輸入、自動網路搜尋與使用者記憶 |
| `@標記`         | 標記機器人聊天   | 與 `/oai` 相同功能 — 只需標記機器人並附上訊息或圖片，即可自然地開始對話                                                                     |
